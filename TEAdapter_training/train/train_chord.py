...
def main():
    ...
    train_dataset = ChordDataset(config=audioldm2_config)
    ...
    for epoch in range(start_epoch, opt.epochs):
        ...
        for _, data in enumerate(train_dataloader):
            ...
            chord_data = data['extra_cond_log_mel_spec'][opt.name].unsqueeze(1)
            features_adapter = model_ad(chord_data.to(device))
            ...
            if (rank == 0) and ((current_iter + 1) % audioldm2_config['step']['save_checkpoint_every_n_steps'] == 0):
