...
class DDIMSampler(object):
    ...
    def p_sample_ddim(
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            # TODO: torch.cat([c, append_to_context] will be replaced
            ...
            # TODO: No append_to_context now
            model_uncond = self.model.apply_model(
                x_in, t_in, unconditional_conditioning, features_adapter=features_adapter
            )
            model_t = self.model.apply_model(x_in, t_in, c, features_adapter=features_adapter)
