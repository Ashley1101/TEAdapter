...
def main():
    ...
    train_dataset = MelodyDataset(config=audioldm2_config, dataset_name=["musiccaps","FMA-outro"])
    ...
    experiments_root = osp.join('experiments', f"{opt.name}_outro")
    ...
    if resume_state is None:
        ...
        log_file = osp.join(experiments_root, f"train_{opt.name}_outro_{get_time_str()}.log")
